...
public class NetworkContentDelete extends AsyncTask<String, Void, String> {
    private URL Url;
    private String URL_Address = "http://10.100.103.51/AppDB/p_content_delete.jsp";
    ...
    protected String doInBackground(String... strings) {
        ...
        Log.i("Get con Delete result", res);
