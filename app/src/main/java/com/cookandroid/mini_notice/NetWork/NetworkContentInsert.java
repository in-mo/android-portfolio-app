...
public class NetworkContentInsert extends AsyncTask<String, Void, String> {
    private URL Url;
    private String URL_Address = "http://10.100.103.51/AppDB/p_content_insert.jsp";
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            buffer.append("&reg_id").append("=").append(strings[2]);
