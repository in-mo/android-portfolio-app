...
public class NetworkReadCountSet extends AsyncTask<String, Void, String> {
    private URL Url;
    private String URL_Address = "http://10.100.103.51/AppDB/content_readcount_update.jsp";
    ...
    protected String doInBackground(String... strings) {
        ...
        Log.i("Get ReadCount result", res);
