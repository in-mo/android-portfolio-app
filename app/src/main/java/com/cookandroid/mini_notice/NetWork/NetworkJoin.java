...
public class NetworkJoin extends AsyncTask<String, Void, String> {
    private URL Url;
    private String URL_Address = "http://10.100.103.51/AppDB/p_join.jsp";
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            // 전송값 설정
//            tring id, password, name, email, reg_date;
            ...
            buffer.append("&email").append("=").append(strings[3]);
        ...
        Log.i("Get Join Data result", res);
