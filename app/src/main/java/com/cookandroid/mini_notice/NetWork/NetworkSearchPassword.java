...
public class NetworkSearchPassword extends AsyncTask<String, Void, String> {
    private URL Url;
    private String URL_Address = "http://10.100.103.51/AppDB/p_password_search.jsp";
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            buffer.append("&email").append("=").append(strings[2]);
