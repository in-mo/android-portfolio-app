...
public class NetworkReplyFavorUpdate extends AsyncTask<String, Void, String> {
    private URL Url;
    private String URL_Address = "http://10.100.103.51/AppDB/p_reply_favor_update.jsp";
    ...
    protected String doInBackground(String... strings) {
        ...
        Log.i("rep favor Update result", res);
